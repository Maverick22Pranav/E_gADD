...
<body background="resources/images/yello back.jpg">
	...
	<ef:form class="form-horizontal" action="${context}/addCategory"
		...
		<div class="form-group">
			<label class="control-label col-sm-2" for="name">Enter the
				category:</label>
			<div class="col-sm-10">
				<ef:input type="text" path="name" class="form-control"
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<a href="${context}/category">
					<button type="submit" class="btn btn-danger" id="btnsubmit">Add
						category</button>
				</a>
			</div>
		</div>
